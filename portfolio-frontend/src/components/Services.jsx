      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 flex items-baseline">
            <span className="text-cyanAccent font-mono text-xl md:text-2xl mr-3">03.</span> Ce que je peux faire pour vous
          </h2>
          <p className="text-slate-400 text-lg max-w-2xl mb-12">
            Entreprise, startup ou indépendant : je vous accompagne de l'idée à la mise en ligne, en mission freelance ou au sein de votre équipe.
          </p>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.tech.map((t) => (
                        <span key={t} className="px-2.5 py-0.5 rounded text-xs font-mono text-greenAccent bg-greenAccent/10">{t}</span>
                      ))}
                    </div>
                  </div>
                </motion.div>
          ...
          {/* Méthode de travail */}
          <h3 className="text-2xl font-bold text-slate-100 mt-20 mb-8">Comment je travaille</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {process.map((item, idx) => (
              ...
              >
                ...
                <h4 className="font-display text-lg font-semibold text-slate-100 mt-1 mb-2">{item.title}</h4>
          ...
          <div className="mt-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 p-8 rounded-2xl border border-cyanAccent/30 bg-gradient-to-r from-cyanAccent/10 to-greenAccent/5">
            <div>
              <p className="font-display text-2xl font-bold text-slate-100">Un projet ou un poste à pourvoir ?</p>
              <p className="text-slate-400 mt-1">Parlons-en : je suis disponible pour un emploi, du freelance ou un stage.</p>
            </div>
